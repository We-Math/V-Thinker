    ...
    def infer(
        ...
        *,
        ...
        for i, _ in enumerate(prompts):
            ...
            generation_config.stop = ["</answer>", "</code>", "<code>", "<|im_end|>", "<|endoftext|>"]
            # print("debug: generation_config.stop =", getattr(generation_config, "stop", None))
            # print("debug: generation_config.stop_words =", getattr(generation_config, "stop_words", None))
