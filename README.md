...
[![Dataset](https://img.shields.io/badge/Dataset-HuggingFace-yellow?logo=huggingface)](https://huggingface.co/We-Math)
...
## 📣 Latest News
- **[Nov 26, 2026]**: 🔄 We have re-released [**VTBench**](https://huggingface.co/datasets/We-Math/VTBench) on HuggingFace. The updated LMM judge prompt is now available in the HuggingFace README, and should be followed exactly for consistent evaluation. All evaluation settings, together with the updated judge framework, will be included in a revised arXiv version of the paper to be released later this week!
...
- **[Nov 7, 2026]**: 📄 Our paper is now available on [**arXiv**](https://arxiv.org/abs/2511.04460) and [**Hugging Face daily paper**](https://huggingface.co/papers/2511.04460).
